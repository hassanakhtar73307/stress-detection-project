      ...
      <div className="admin-breakdown-list">
        {(rows || []).map((row) => (
          ...
          >
            ...
            <div
              className="admin-breakdown-track"
              aria-hidden="true"
            >
              <span
                style={{
...
export default function AdminPage({ onBack }) {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      axios.get(
        `${API_BASE}/admin/users?limit=500`,
        {
          headers: authHeader,
          timeout: 30000,
        },
  ...
  return (
    <main className="admin-page">
      ...
      {error && (
        <section
          className="admin-status-card error"
          role="alert"
        >
          {error}
        </section>
          ...
          <>
            ...
            >
              ...
              <article>
                ...
                <strong>
                  {totals.registrations_7d ||
                    0}
                </strong>

                <small>
                  {totals.registrations_30d ||
                    0}{' '}
                  in the last 30 days
                </small>
              </article>
              ...
              <article>
                ...
                <strong>
                  {totals.complete_profiles ||
                    0}
                </strong>

                <small>
                  Routine, goal and device
                  provided
                </small>
              </article>
